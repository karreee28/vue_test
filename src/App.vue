...
<p>&lt;section&gt;과 &lt;div&gt;, &lt;header&gt;, &lt;footer&gt;, &lt;article&gt; 엘리먼트의 차이점은 무엇인가요?
...
<p>블럭 레벨 엘리먼트와 인라인 엘리먼트의 차이는 무엇일까요?
...
스스로 의미를 갖는 시멘틱 태그를 사용하여 작성된 웹 페이지</p>

<p>* CSS를 HTML에 적용하는 세 가지 방법과 장단점
* Inline Style
...
단점 : 파일을 계속적으로 관리해주면서 HTML 문서를 만들어 나가야 하기에 불편,</p>

<p>* float 속성은 왜 좋지 않을까요?
...
<p>Flexbox(Flexible box)와 CSS Grid의 차이와 장단점은 무엇일까요?
...
Grid 단점 : ie 브라우저의 지원이 제한적</p>

<p>* 브라우저가 브라우저의 윈도우 화면에 DOM을 생성하는 과정은 내부적으로 어떻게 진행되나요?
...
4. DOM 생성 : HTML 마크업이 여러 태그간의 관계를 정의하기 때문에 생성된 객체는 트리 데이터 구조 내에 연결</p>

<p>크롬, 사파리, 익스플로러의 렌더링 엔진은 어떤 것입니까?
크롬 : 블링크
사파리 : 웹킷
익스플로러 : 트라이던트</p>
...
<p>* MVVM을 지향하는 자바스크립트 프레임워크에는 무엇이 있나요?
